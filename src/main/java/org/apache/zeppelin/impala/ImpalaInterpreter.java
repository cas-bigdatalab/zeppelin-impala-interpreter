...
import org.apache.zeppelin.impala.security.JDBCSecurityImpl;
...
/**
 * Impala interpreter for Zeppelin. This interpreter can also be used for accessing Impala
 *
 * <ul>
...
public class ImpalaInterpreter extends Interpreter {
    ...
    private Logger logger = LoggerFactory.getLogger(ImpalaInterpreter.class);
    ...
    public Connection getConnection(String propertyKey, String user)
        ...
        if (null == connection) {
            ...
            if (StringUtils.isEmpty(property.getProperty("zeppelin.jdbc.auth.type"))) {
                connection = DriverManager.getConnection(url + ";auth=noSasl", properties);
            } else {
